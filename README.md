...
Gogidecks suits only for building decks for regular 1v1 battle, consisting of 8 cards. Each card may be either a troop, a building or a spell. Each card costs defined amount of elixir (mana), and has its own unique values of attack, hp, and other characteristics.
